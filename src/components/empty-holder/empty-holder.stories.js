...
storiesOf('Components|EmptyHolder', module).add('EmptyHolder', () => (
  <StoriesStyle>
    ...
    <H1>EmptyHolder</H1>
    <p>
      A component that shows an infomation about the empty content
      in inner centralized vertically and horizontally wrapper to simbolize
      that the area has no content.
    </p>
    <Grid container>
