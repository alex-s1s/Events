                        ...
                        <div>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    {cidade.map((fin) =>
                                        <li>
                                            <input class="form-check-input" type="checkbox" name={fin.sigla} id={fin.id} onChange={handleChangeCity} />
                        ...
                        <div className="finalidade">
                            ...
                            {finalidade.map((fin) =>
                                <div key={fin.id} class="form-check">
                                    <input class="form-check-input" type="checkbox" name={fin.name} id={`for${fin.id}`} onChange={handleChange} />
                        ...
                        <div className="TypeImovel">
                            ...
                            {imoveis.map((im) =>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name={im.name} id={`flex${im.id}`} onChange={handleChangeImoveis} />
